...
namespace RIH_GameLogic.Models.VersionOne.Devouts
{
    public class Executioner : BaseUnit
    {
        ...
        public Executioner(int Id, int Cost, int Move, int Life, bool Fly, string DemonName, string ClassName, int ClassEnum, bool DefaultRules, DateTime DateCreated, DateTime DateModified)
