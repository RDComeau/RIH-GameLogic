...
namespace RIH_GameLogic.Models.VersionOne.Minions.GreaterDemons
{
    ...
    {
        public MarquessDWinter() { }

        public MarquessDWinter(int Id, int Cost, int Move, int Life, bool Fly, string DemonName, string ClassName, int ClassEnum, bool DefaultRules, DateTime DateCreated, DateTime DateModified)
