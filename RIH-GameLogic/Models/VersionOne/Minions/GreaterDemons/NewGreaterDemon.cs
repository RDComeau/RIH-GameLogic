...
{
    public class NewGreaterDemon : BaseUnit
    {
        public NewGreaterDemon() { }

        public NewGreaterDemon(int Id, int Cost, int Move, int Life, bool Fly, string DemonName, string ClassName, int ClassEnum, bool DefaultRules, DateTime DateCreated, DateTime DateModified)
        ...
        public override int classEnum { get; set; } = Convert.ToInt32(DemonClass.MinionsGreaterDemons);
