...
namespace RIH_GameLogic.Models.VersionOne.Minions.LesserDemons
{
    ...
    {
        public SlaughterFiend() { }

        public SlaughterFiend(int Id, int Cost, int Move, int Life, bool Fly, string DemonName, string ClassName, int ClassEnum, bool DefaultRules, DateTime DateCreated, DateTime DateModified)
