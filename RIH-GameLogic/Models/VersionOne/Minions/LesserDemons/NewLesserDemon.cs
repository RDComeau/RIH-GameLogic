...
{
    class NewLesserDemon : BaseUnit
    {
        public NewLesserDemon() { }

        public NewLesserDemon(int Id, int Cost, int Move, int Life, bool Fly, string DemonName, string ClassName, int ClassEnum, bool DefaultRules, DateTime DateCreated, DateTime DateModified)
