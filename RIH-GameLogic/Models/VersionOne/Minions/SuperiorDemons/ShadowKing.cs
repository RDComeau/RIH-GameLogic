...
namespace RIH_GameLogic.Models.VersionOne.Minions.SuperiorDemons
{
    public class ShadowKing : BaseUnit
    {
        ...
        public ShadowKing(int Id, int Cost, int Move, int Life, bool Fly, string DemonName, string ClassName, int ClassEnum, bool DefaultRules, DateTime DateCreated, DateTime DateModified)
