...
namespace RIH_GameLogic.Models.VersionOne.Leaders
{
    public class Schemer : BaseUnit
    {
        ...
        public Schemer(int Id, int Cost, int Move, int Life, bool Fly, string DemonName, string ClassName, int ClassEnum, bool DefaultRules, DateTime DateCreated, DateTime DateModified)
