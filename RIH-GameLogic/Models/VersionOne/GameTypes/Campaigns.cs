...
{
    public class Campaigns : BaseGameTypes
    {
        public override int id { get; set; }
        public override string name { get; set; } = "Campaign";
        public override int nameEnum { get; set; } = Convert.ToInt32(GameType.Campaign);
